...
radius_ana_interp = np.interp(press_interp,
                              press_ana.astype('f'), radius_ana.astype('f'))
radius_num_interp = np.interp(press_interp,
                              press_num.astype('f'), radius_num.astype('f'))
